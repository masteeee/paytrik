...
</html>SESSION['level'] == 'Petugas' ){ ?>
            <li class="title-menu"><a href="validasipelanggan.php"><span> Pelanggan </span></a></li>
<?php } ?><li class="title-menu"><a href="inputtagihan.php"><span> Tagihan </span></a></li>
			<li class="title-menu"><a href="inputpembayaran.php"><span> Pembayaran </span></a></li>
			<li><a class="btn-logout"><span> Logout </span></a></li>
		</ul>
	</div>
